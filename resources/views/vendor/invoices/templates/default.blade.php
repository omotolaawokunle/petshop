        ...
        <table class="table table-items">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="border-0 pl-0">{{ __('invoices::invoice.id') }}</th>
                    <th scope="col" class="border-0 pl-0">{{ __('invoices::invoice.title') }}</th>
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">{{ __('invoices::invoice.units') }}</th>
                    @endif
                    <th scope="col" class="text-center border-0">{{ __('invoices::invoice.quantity') }}</th>
                    <th scope="col" class="text-right border-0">{{ __('invoices::invoice.unit_price') }}</th>
                    ...
                    @endif
                    <th scope="col" class="text-right border-0 pr-0">{{ __('invoices::invoice.price') }}</th>
                </tr>
            </thead>
            <tbody>
                @php($sn = 0)
